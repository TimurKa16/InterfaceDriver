...
PAGE 0 :
 ...
 //  IQTABLES    : origin = 0x3FE000, length = 0x000B50     /* IQ Math Tables in Boot ROM */
  ...
  // IQTABLES3   : origin = 0x3FEBDC, length = 0x0000AA	  /* IQ Math Tables in Boot ROM */
   ...
   FLASHML      : origin = 0x82000, length = 0x026000     /* on-chip FLASH */
  ...
  // FLASHF      : origin = 0xA8000, length = 0x008000     /* on-chip FLASH */
   FLASHE      : origin = 0xB0000, length = 0x01000      /* on-chip FLASH */
  // FLASHD      : origin = 0xB8000, length = 0x002000      /* on-chip FLASH */
   FLASHC      : origin = 0xBA000, length = 0x004000      /* on-chip FLASH */
