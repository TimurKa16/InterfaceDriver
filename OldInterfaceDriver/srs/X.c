...
Uint32 xDeltAngOut = 0;
Uint32 xDeltAngLow = 0;
Uint32 yDeltAngOut = 0;
Uint32 yDeltAngLow = 0;
Uint32 zDeltAngOut = 0;
Uint32 zDeltAngLow = 0;
...
//            if(((int32)((((Uint32)xDeltAngOut)<<16)+((Uint32)xDeltAngLow))) < 40000)
//                xDeltAng = ((int32)((((Uint32)xDeltAngOut)<<16)+((Uint32)xDeltAngLow)));
//            if (((int32)((((Uint32)yDeltAngOut)<<16)+((Uint32)yDeltAngLow))) < 40000)
//                yDeltAng = ((int32)((((Uint32)yDeltAngOut)<<16)+((Uint32)yDeltAngLow)));
//            if (((int32)((((Uint32)zDeltAngOut)<<16)+((Uint32)zDeltAngLow))) > 40000)
//                zDeltAng = ((int32)((((Uint32)zDeltAngOut)<<16)+((Uint32)zDeltAngLow)));
//
//            xAng = xAng + xDeltAng/910/100/1000;   //0.02/65536(ед. разряда в градусах), 0.02/65536*60*60 (ед. разряда в секундах)  /100 - частота   1/число = ед.разряда
//            yAng = yAng + yDeltAng/910/100/1000;
//            zAng = zAng + zDeltAng/910/100/1000;
...
//            Z_Gyro = ((int32)((((Uint32)BRFData->Z_GYRO_OUT)<<16)+((Uint32)BRFData->Z_GYRO_LOW)))/910/60;
            ...
            if(X_GyroInt32/910/100 < 60000)
                DeltaXSek = DeltaXSek + X_GyroInt32/910/100;
            if(Y_GyroInt32/910/100 < 60000)
                DeltaYSek = DeltaYSek + Y_GyroInt32/910/100;
            if(Z_GyroInt32/910/100 < 60000)
                DeltaZSek = DeltaZSek + Z_GyroInt32/910/100;
