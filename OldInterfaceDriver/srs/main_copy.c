...
double      DeltaYSek = 0;
double      DeltaZSek = 0;
double      X_GyroInt32 = 0;
double      Y_GyroInt32 = 0;
double      Z_GyroInt32 = 0;
int32      X_Gyro = 0;
int32      Y_Gyro = 0;
int32      Z_Gyro = 0;
...
//            Z_Gyro = ((int32)((((Uint32)BRFData->Z_GYRO_OUT)<<16)+((Uint32)BRFData->Z_GYRO_LOW)))/728/60;
            ...
            //if(X_GyroInt32/910/100 < 60000 || X_GyroInt32/910/100 > -60000)
//                            DeltaXSek = DeltaXSek + X_GyroInt32/910/100 + x;
//                        //if(Y_GyroInt32/910/100 < 60000 || Y_GyroInt32/910/100 > -60000)
//                            DeltaYSek = DeltaYSek + Y_GyroInt32/910/100 + y;
//                        //if(Z_GyroInt32/910/100 < 60000 || Z_GyroInt32/910/100 > -60000)
//                            DeltaZSek = DeltaZSek + Z_GyroInt32/910/100 + z;
//
//
